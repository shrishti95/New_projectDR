...
if len(rows)==5:
 keys=['accuracy','macro_f1','macro_auc','cohens_kappa_unweighted','qwk','mcc','grade_1_recall','grade_3_recall']
 ...
 for r in rows:
  m=r['metrics']; lines.append(f"| {r['fold']} | {r['best_epoch']} | {m['validation_loss']:.6f} | {m['accuracy']:.6f} | {m['macro_f1']:.6f} | {m['qwk']:.6f} | {m['grade_1_recall']:.6f} | {m['grade_3_recall']:.6f} |")
